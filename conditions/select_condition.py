...
def select_random_compatible_conditions(valid_condition_list, n_conditions=3, matrix_file="../../conditions/condition-conpa.csv"):
    """
...
if __name__ == "__main__":
    ...
    for _ in range(nx):
        ...
        selected = select_random_compatible_conditions(example_conditions, n_conditions=2,matrix_file="../../conditions/condition-conpa.csv")
        # 更新条件出现次数
